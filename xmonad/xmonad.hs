...
--
myLayout = spacingWithEdge 3 $ avoidStruts $ tiled ||| Mirror tiled
  where
...
--
main = do
	xmproc <- spawnPipe "xmobar -x 0 /home/quask/.config/xmobar/xmobarrc"
...
defaults = def {
      ...
      -- hooks, layouts
        layoutHook         = lessBorders Screen $ toggleLayouts Full $ myLayout,
